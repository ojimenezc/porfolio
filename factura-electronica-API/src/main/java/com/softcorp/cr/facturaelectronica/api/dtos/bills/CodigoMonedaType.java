...
public class CodigoMonedaType {
    ...
    @XmlElement(name = "CodigoMoneda", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/facturaElectronica", required = true)
    protected String codigoMoneda;
    @XmlElement(name = "TipoCambio", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/facturaElectronica", required = true)
