...
public class ImpuestoType {
    ...
    @XmlElement(name = "CodigoTarifa", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaCreditoElectronica")
    protected String codigoTarifa;
    @XmlElement(name = "Tarifa", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaCreditoElectronica")
    protected BigDecimal tarifa;
    @XmlElement(name = "FactorIVA", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaCreditoElectronica")
    protected BigDecimal factorIVA;
    @XmlElement(name = "Monto", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaCreditoElectronica", required = true)
    protected BigDecimal monto;
    @XmlElement(name = "MontoExportacion", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaCreditoElectronica")
    protected BigDecimal montoExportacion;
    @XmlElement(name = "Exoneracion", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaCreditoElectronica")
