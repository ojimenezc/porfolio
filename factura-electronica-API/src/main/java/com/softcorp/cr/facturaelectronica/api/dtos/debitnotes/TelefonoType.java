...
public class TelefonoType {
    ...
    @XmlElement(name = "CodigoPais", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica", required = true)
    protected BigInteger codigoPais;
    @XmlElement(name = "NumTelefono", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica", required = true)
