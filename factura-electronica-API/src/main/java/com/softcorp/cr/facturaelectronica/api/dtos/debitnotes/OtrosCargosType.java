...
public class OtrosCargosType {
    ...
    @XmlElement(name = "TipoDocumento", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica", required = true)
    protected String tipoDocumento;
    @XmlElement(name = "NumeroIdentidadTercero", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica")
    protected String numeroIdentidadTercero;
    @XmlElement(name = "NombreTercero", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica")
    protected String nombreTercero;
    @XmlElement(name = "Detalle", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica", required = true)
    protected String detalle;
    @XmlElement(name = "Porcentaje", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica")
    protected BigDecimal porcentaje;
    @XmlElement(name = "MontoCargo", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica", required = true)
