...
public class UbicacionType {
    ...
    @XmlElement(name = "Provincia", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/facturaElectronica", required = true)
    protected BigInteger provincia;
    @XmlElement(name = "Canton", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/facturaElectronica", required = true)
    protected String canton;
    @XmlElement(name = "Distrito", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/facturaElectronica", required = true)
    protected String distrito;
    @XmlElement(name = "Barrio", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/facturaElectronica")
    protected String barrio;
    @XmlElement(name = "OtrasSenas", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/facturaElectronica", required = true)
