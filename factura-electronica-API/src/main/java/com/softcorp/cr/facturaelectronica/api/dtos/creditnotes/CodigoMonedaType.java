...
public class CodigoMonedaType {
    ...
    @XmlElement(name = "CodigoMoneda", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaCreditoElectronica", required = true)
    protected String codigoMoneda;
    @XmlElement(name = "TipoCambio", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaCreditoElectronica", required = true)
