...
public class ImpuestoType {
    ...
    @XmlElement(name = "CodigoTarifa", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/tiqueteElectronico")
    protected String codigoTarifa;
    @XmlElement(name = "Tarifa", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/tiqueteElectronico")
    protected BigDecimal tarifa;
    @XmlElement(name = "FactorIVA", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/tiqueteElectronico")
    protected BigDecimal factorIVA;
    @XmlElement(name = "Monto", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/tiqueteElectronico", required = true)
    protected BigDecimal monto;
    @XmlElement(name = "Exoneracion", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/tiqueteElectronico")
